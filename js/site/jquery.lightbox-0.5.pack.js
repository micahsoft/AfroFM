...
(function($) {
	...
	$.fn.lightBox = function(settings) {
		...
		settings = jQuery.extend({
			...
			imageLoading:			theme_base+'images/lightbox-ico-loading.gif',		// (string) Path and the name of the loading icon
			imageBtnPrev:			theme_base+'images/lightbox-btn-prev.gif',			// (string) Path and the name of the prev button image
			imageBtnNext:			theme_base+'images/lightbox-btn-next.gif',			// (string) Path and the name of the next button image
			imageBtnClose:			theme_base+'images/lightbox-btn-close.gif',		// (string) Path and the name of the close btn
			imageBlank:				theme_base+'images/lightbox-blank.gif',			// (string) Path and the name of a blank image (one pixel)
